...
import { Payload, TokenManager } from '@/use-cases/auth/ports'
import { HttpResponse } from '@/presentation/controllers/ports'
import { forbidden, ok, serverError } from '@/presentation/controllers/utils'
...
export class Authentication implements Middleware {
  ...
  async handle (request: AuthRequest): Promise<HttpResponse> {
    try {
      ...
      const payload: Payload = decodedTokenOrError.value
